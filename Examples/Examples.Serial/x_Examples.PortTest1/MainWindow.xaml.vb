...
Imports GBD.Port.BusPirate
Imports GBD.Port.Serial.Net
Imports System.Text
Imports System.Reactive.Linq
Imports System.Threading
Imports GBD.Port.BusPirate.Binary.Iface
Imports GBD.Port.LinkMSO.Devices.MSO19
...
Class MainWindow
    ...
    Private Sub test3()
        Dim x1 = MSOSerialPort.Find_MSO_Devices
    ...
    Private Sub test1()
        ...
        sport2.DataRx.Subscribe( _
            Sub(item)
                Debug.WriteLine("Data Output:" & Encoding.ASCII.GetString(item))
            End Sub)

        sport1.DataTx.Subscribe( _
            Sub(item)
                Debug.WriteLine("Data Input:" & Encoding.ASCII.GetString(item))
            End Sub)
